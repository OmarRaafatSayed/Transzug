  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#0a0f1a]">
        ...
        <section className="py-12 sm:py-20">
          <div className="container mx-auto px-4 sm:px-8 max-w-5xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
              ...
              {/* Features */}
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold mb-8 text-white">{t('included')}</h2>
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Link href={`/${locale}/kontakt`}
                    className="flex-1 border-2 border-gray-700 text-white py-4 px-6 rounded-xl font-semibold text-center hover:bg-gray-800 hover:border-gray-600 transition-colors">
                    {t('sendRequest')}
                  </Link>
                </div>
              </div>
        ...
        {/* Related Services */}
        {related.length > 0 && (
          <section className="py-12 sm:py-16 bg-[#0d1220]">
            <div className="container mx-auto px-4 sm:px-8">
              <h2 className="text-2xl sm:text-3xl font-bold mb-8 text-white">{t('otherServices')}</h2>
