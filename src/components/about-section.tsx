  ...
  return (
    <section className="container mx-auto px-4 sm:px-8 py-12 sm:py-20 bg-[#0a0f1a]">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        {/* Content */}
        <div>
          <div className="text-sm text-brand-primary font-semibold mb-4 uppercase tracking-wider">
            {t('badge')}
          </div>
          ...
          <ul className="space-y-3 mb-8">
            <li className="flex items-start gap-3">
              <svg className="w-6 h-6 text-brand-primary mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <Link href={`/${locale}/ueber-uns`} className="inline-flex items-center text-brand-primary font-semibold hover:text-brand-hover transition-colors group">
            {t('cta')}
