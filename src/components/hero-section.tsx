        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-12 sm:mb-20">
            <Link href={`/${locale}/kontakt`}
              className="bg-orange-600 text-white px-6 sm:px-8 py-4 rounded-lg hover:bg-orange-700 transition-all font-semibold inline-flex items-center justify-center gap-2 shadow-lg">
              {t('ctaPrimary')}
